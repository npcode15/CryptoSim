...
public class Twofish_E extends JFrame implements ActionListener
{
	...
	{ 
		...
		{   
			if(keyselect.isSelected())
			{
				...
				try
				{
					stream = new FileOutputStream("PrivateKey[Twofish]"+".txt"); 
	...
	public static String encrypt (String plaintext, String key) throws UnsupportedEncodingException, InvalidKeyException
	{
		...
		String encryptedString = Base64.encodeBase64URLSafeString(encryptedText);
