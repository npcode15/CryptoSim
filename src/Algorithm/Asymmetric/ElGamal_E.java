...
public class ElGamal_E extends JFrame implements ActionListener
{
	static String plaintext = "";
	static BigInteger ciphertext = null;
	...
	{ 
		...
		{   
			...
			else
			{
				...
				System.out.println("Ciphertext : Length >> "+ciphertext+" : "+"");
	...
	public static BigInteger encrypt(String plainText, String encryptionKey) throws NoSuchAlgorithmException, UnsupportedEncodingException
	{		
        ...
        d = crmodp.modInverse(p);
        
        FileOutputStream stream = null;
		PrintStream out = null;
		try
		{
			stream = new FileOutputStream("PublicKey[ElGamal]"+".txt"); 
			String text = d+"";
