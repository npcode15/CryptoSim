...
public class TEA 
{
 ...
 public static void main(String[] args) 
 {
	 ...
	 byte[] buf = new Base64().decode(testenc);
	 byte[] result = tea.decrypt(buf); 
	 String test = new String(result);

	 /* Ensure that all went well */
	 System.out.println(quote+"\n");
	 System.out.println("testenc : "+test);
	 
	 if("".equals(testenc))
