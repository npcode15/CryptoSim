...
public class BlowFish_E extends JFrame implements ActionListener
{
	...
	{ 
		...
		{   
			if(keyselect.isSelected())
			{
				...
				try
				{
					stream = new FileOutputStream("PrivateKey[Blowfish]"+".txt"); 
	...
	{
		SecretKey key = new SecretKeySpec(encryptionKey.getBytes("UTF-8"), "Blowfish");
