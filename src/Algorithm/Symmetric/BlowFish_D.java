...
public class BlowFish_D extends JFrame implements ActionListener
{
	...
	private static String decrypt(String ciphertext, String decryptionKey) throws Exception
	{
		byte[] keyData = decryptionKey.getBytes();
		SecretKeySpec secretKeySpec = new SecretKeySpec(keyData, "Blowfish");

		Cipher cipher = Cipher.getInstance("Blowfish");
		cipher.init(Cipher.DECRYPT_MODE, secretKeySpec);
		byte[] decordedValue = new Base64().decodeBase64(ciphertext);
