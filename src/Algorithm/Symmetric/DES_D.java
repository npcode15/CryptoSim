...
public class DES_D extends JFrame implements ActionListener
{
	...
	public static String decrypt(String cipherText, String decryptionKey) throws Exception
	{
		...
		SecretKeySpec key = new SecretKeySpec(decryptionKey.getBytes("UTF-8"), "DES");
		cipher.init(Cipher.DECRYPT_MODE, key, new IvParameterSpec(IV.getBytes("UTF-8")));
		byte[] decodedValue = new Base64().decodeBase64(cipherText);
		byte[] decValue = cipher.doFinal(decodedValue);
		String decryptedValue = byte2String(decValue); //new Base64().encodeToString(decValue);
