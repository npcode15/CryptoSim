...
public class ElGamal_D extends JFrame implements ActionListener
{
	...
	static private BigInteger p, EC, d, plainText;
	...
	public static String decrypt(String cipherText, String decryptionKey) throws Exception
	{
		...
		p=new BigInteger(arr[1].trim());//BigInteger p=new BigInteger("14055763005495744011");
		EC=new BigInteger(arr[2].trim());//BigInteger EC=new BigInteger("3212158341534190676");
		d=new BigInteger(decryptionKey);//BigInteger d=new BigInteger("6568138068600247505");

		plainText = d.multiply(EC).mod(p);
